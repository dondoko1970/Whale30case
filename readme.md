...
### 製作動機
前作「[Dolphin30](https://github.com/dondoko1970/Dolphin30/blob/main/readme.md)」は、(準)オルソリニア型で3×10=30キーのコンセプトを実現したキーボードでした。
...
- おすすめのキーマップ、レイヤー活用法、おすすめの同時押し機能設定などを紹介しています。
(Dolphin30の記事を再掲)
